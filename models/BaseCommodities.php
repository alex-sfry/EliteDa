...
class BaseCommodities extends Model
{
    ...
    public function getMarketCommodities($market_id)
    {
    }

    public function getMarketStation($market_id)
    {
    }

    public function getMarketSystem($market_id)
    {
    }

    public function getCommoditiesListByCategory($cat)
    {
    }
}
