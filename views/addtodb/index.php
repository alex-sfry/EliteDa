    ...
    <div class="container-xxl px-3 align-items-center h-100">
        <div class="row justify-content-center align-items-center h-100">
            <div class="col-lg-5 align-items-center">
                <div class="bg-light p-3 rounded-2 sintony-reg d-flex flex-column row-gap-1" style="width: fit-content">
                    <div class="add-to-db d-flex align-items-center column-gap-2">
                        <span>Materials</span>
                        <button id="addMaterials" class="ms-auto btn btn-primary btn-sm">Submit</button>
                    </div>
                    <div class="add-to-db d-flex align-items-center column-gap-2">
                        <span>Engineers</span>
                        <button id="addEngineers" class="ms-auto btn btn-primary btn-sm">Submit</button>
                    </div>
                </div>
            </div>
        </div>
